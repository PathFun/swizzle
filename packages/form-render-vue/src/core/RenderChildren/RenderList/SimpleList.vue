    ...
    return () => {
        ...
        return h('div', { key: idx, style: { display: 'flex' } }, [
            ...
            h('div', { style: { marginTop: '6px' } },[
              !props.hideDelete && h(Popconfirm, {
                ...
                okText: '确定',
                cancelText: '取消'
              }, h(DeleteOutlined, { style: { fontSize: '17px', marginLeft: '8px' } })),
              !props.hideAdd && !props.hideCopy && h(CopyOutlined, { style: { fontSize: '15px', marginLeft: '8px' } }),
              !props.hideMove && [h(ArrowUpOutlined, { style: { fontSize: '15px', marginLeft: '8px' }, onClick: () => moveItemUp(idx) })],
              !props.hideMove && [h(ArrowDownOutlined, { style: { fontSize: '15px', marginLeft: '8px' }, onClick: () => moveItemDown(idx) })],
            ])
        ] )
      });
      ...
      return h('div', { class: 'fr-list-1' }, [
          ...
          h('div', { style: { marginTop: displayList.length > 0 ? 0 : '8px' } }, [
            !props.hideAdd && h(Button, { ...addBtnProps, type: 'dashed', onClick: addItem }, { default: () => '新增一条' }),
            ...childrenBtn
          ])
      ])
    }
