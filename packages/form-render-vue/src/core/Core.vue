<script lang="ts">
import { computed, defineComponent, PropType, ref, watch, watchEffect, h } from 'vue';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const item = computed(()=> props.formItem ? props.formItem : form.flatten[props.id]);
    ...
    const effectiveLabelWidth: string | number = getParentProps('labelWidth', props.id, form.flatten) || labelWidth;

    const coreValue: any = computed(() => getValueByPath(form.formData, dataPath));
